    ...
    <>
      {user ? (
        ...
        <div className="min-h-screen bg-black text-white flex">
          <div className="hidden sm:flex sm:flex-1 md:flex md:flex-1 lg:flex lg:flex-1 items-center justify-center">
            <TwitterLogo className="text-white h-80 w-80" />
          </div>

          <div className="flex-1 sm:flex sm:flex-1 lg:flex flex flex-col items-center justify-center px-8 lg:px-16 max-w-lg lg:max-w-2xl">
              ...
              <div className="space-y-4 max-w-xs">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-black px-2 text-gray-400">or</span></div>
                </div>
                <Button
